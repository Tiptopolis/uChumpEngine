...
public class uInputListener extends InputListener{
	...
	private iObject caster;//new addition, for old method of event tracking
	public boolean active = true;

	/** Create a listener where {@link #clicked(InputEvent, float, float)} is only called for left clicks.
	 * @see #ClickListener(int) */
	public uInputListener()
	{
		
	}
	
	public uInputListener (iObject caster) {
		this.caster = caster;//new addition
	}


	/** @see #setButton(int) */
	public uInputListener (int button) {
		this.button = button;
	}
